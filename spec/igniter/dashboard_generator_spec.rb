  ...
  it "layers a mounted dashboard on top of the base scaffold" do
    Dir.mktmpdir do |tmp|
      Dir.chdir(tmp) do
        ...
        expect(File.exist?("my_hub/apps/dashboard/app/support/stack_overview.rb")).to be true
        expect(File.exist?("my_hub/apps/dashboard/app/handlers/home_handler.rb")).to be true
        ...
        dashboard_handler = File.read("my_hub/apps/dashboard/app/handlers/home_handler.rb")
        dashboard_support = File.read("my_hub/apps/dashboard/app/support/stack_overview.rb")
