...
- Keep existing `NetworkBackend#subscribe` / `fact_written` behavior green.
...
- No general workflow execution or contract callbacks inside `igniter-store`.
...
Track: igniter-store/changefeed-events-v0
