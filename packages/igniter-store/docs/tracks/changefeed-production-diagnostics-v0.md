...
- Surface changefeed alerts through `StoreServer#observability_snapshot`.
...
- `StoreServer#observability_snapshot` includes changefeed alerts.
...
Track: igniter-store/changefeed-production-diagnostics-v0
