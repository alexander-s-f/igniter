...
3. [open-protocol.md](open-protocol.md) — Store Open Protocol vocabulary.
...
| [server-model.md](server-model.md) | StoreServer + NetworkBackend design |
