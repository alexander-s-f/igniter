...
module Igniter
  module Store
    module IntelligentLedger
      ...
      #
      # Lifecycle: open -> closed -> compacted
      #
      # Once closed, result_hash and output_fact_id are immutable. Compaction
      # marks internal detail as purged but preserves the output and result_hash,
      # so boundary-fidelity replay remains valid after internal facts are gone.
      class LedgerBoundary
        ...
        # Internal detail is marked purged; output and result_hash remain intact.
