  ...
  module Diagnostics
    class Report
      ...
      def to_h
        ...
        Diagnostics.augment_report(report: report, execution: execution)
      end
      ...
      def to_text
        ...
        Diagnostics.append_text(report: report, lines: lines)
      ...
      def to_markdown
        ...
        Diagnostics.append_markdown_summary(report: report, lines: lines)
        ...
        Diagnostics.append_markdown_sections(report: report, lines: lines)
        lines.join("\n")
      end
      ...
      def summarize_serialized_deferred_hash(value)
        ...
        tool_call_count = hash_value(value, :tool_call_count)
        tool_result_count = hash_value(value, :tool_result_count)
        tool_interaction_count = hash_value(value, :tool_interaction_count)
        pending_tool_interaction_count = hash_value(value, :pending_tool_interaction_count)
        completed_tool_interaction_count = hash_value(value, :completed_tool_interaction_count)
        orphan_tool_interaction_count = hash_value(value, :orphan_tool_interaction_count)
        tool_loop_status = hash_value(value, :tool_loop_status)
        tool_loop_complete = hash_value(value, :tool_loop_complete)
        status_count = hash_value(value, :status_count)
        artifact_count = hash_value(value, :artifact_count)
        ...
        parts << "statuses=#{status_count}" if status_count.to_i.positive?
        parts << "tool_calls=#{tool_call_count}" if tool_call_count.to_i.positive?
        parts << "tool_results=#{tool_result_count}" if tool_result_count.to_i.positive?
        parts << "tool_interactions=#{tool_interaction_count}" if tool_interaction_count.to_i.positive?
        parts << "open_tool_interactions=#{pending_tool_interaction_count}" if pending_tool_interaction_count.to_i.positive?
        parts << "completed_tool_interactions=#{completed_tool_interaction_count}" if completed_tool_interaction_count.to_i.positive?
        parts << "orphan_tool_interactions=#{orphan_tool_interaction_count}" if orphan_tool_interaction_count.to_i.positive?
        parts << "tool_loop=#{tool_loop_status}" if tool_loop_status
        parts << "tool_loop_complete=#{tool_loop_complete}" unless tool_loop_complete.nil?
        parts << "artifacts=#{artifact_count}" if artifact_count.to_i.positive?
