...
Igniter::Core::Legacy.require!("igniter/core/dataflow")
require_relative "dataflow/diff"
require_relative "dataflow/diff_state"
require_relative "dataflow/window_filter"
require_relative "dataflow/incremental_collection_result"
require_relative "dataflow/aggregate_operators"
require_relative "dataflow/aggregate_state"
require_relative "model/aggregate_node"
