...
Command support состоит из девяти слоёв: descriptor metadata
...
read models; будущая app security infrastructure остаётся вне этого пакета.
`Store#command_intent`, `Store#command_operation_plan` и
