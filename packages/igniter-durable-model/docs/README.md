...
| [tracks/durable-model-command-activity-projection-v0.md](tracks/durable-model-command-activity-projection-v0.md) | Proposed track for app-safe command activity projection without persistence |
