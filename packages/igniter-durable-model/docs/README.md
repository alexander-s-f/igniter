...
| [tracks/durable-model-command-flow-v0.md](tracks/durable-model-command-flow-v0.md) | Proposed app-owned command flow orchestrator over intent, plan, policy, audit, apply, and lifecycle |
