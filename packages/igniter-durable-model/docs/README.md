...
| [tracks/durable-model-command-intent-boundary-v0.md](tracks/durable-model-command-intent-boundary-v0.md) | Proposed track for pure command intent objects at the app boundary |
