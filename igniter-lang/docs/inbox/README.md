...
| [sparkcrm-ledger-igniter-applicability-analysis-2026-05-20.md](sparkcrm-ledger-igniter-applicability-analysis-2026-05-20.md) | `promoted-track` / active applied-pressure source | [Igniter-Lang Bridge Agent] | Routed by [sparkcrm-contractable-shadowing-pilot-scope-decision-v0](../gates/sparkcrm-contractable-shadowing-pilot-scope-decision-v0.md); pilot scope accepted for `AvailabilityLedger::SlotMap`; next owner/route: `sparkcrm-contractable-shadowing-pilot-scope-letter-v0`; not canon, not implementation authority, not Spark CRM production authority |
