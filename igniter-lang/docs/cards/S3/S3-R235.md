...
- Read:
  ...
  - igniter-lang/docs/tracks/stage3-round235-status-curation-v0.md if present
  - igniter-lang/docs/tracks/stage3-round234-status-curation-v0.md
  - igniter-lang/docs/tracks/
    experimental-igc-run-slice0-implementation-acceptance-decision-v0.md
  - igniter-lang/docs/tracks/
...
- Required proof matrix:
  ...
  - QSD-2: docs/README pointer, if edited, is navigation-only and
    low-authority.
  ...
  - QSD-8: `delegated-experimental:ivm-proof` remains named as
    non-canonical.
  - QSD-9: result packet is described as
    `experimental_igc_run_v0_result` only.
  - QSD-10: no public runtime / Reference Runtime / stable API /
    production claim.
