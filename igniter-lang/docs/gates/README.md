...
| [prop038-contract-digest-compile-refusal-preconditions-decision-v0.md](prop038-contract-digest-compile-refusal-preconditions-decision-v0.md) | S3-R75-C3-A | accepted-preconditions-design-refusal-held | Accepts PROP-038 `contract_digest` compile-refusal preconditions design; no `contract_digest_*` diagnostic is authorized as compile-refusal behavior; authorizes only strict-mode/refusal trigger design next; implementation, compiler/orchestrator, public API/CLI, loader/report, CompatibilityReport, runtime, and production remain closed |
