...
| [prop038-internal-orchestrator-strict-source-status-decision-v0.md](prop038-internal-orchestrator-strict-source-status-decision-v0.md) | S3-R79-C4-A | accepted-design-implementation-held | Accepts internal orchestrator strict-source/status design and authorizes only `strict-refusal-result-shape-and-nonpersisting-path-design-v0` next; no implementation, live compile refusal, public API/CLI, `CompilerResult`, persisted reports/sidecars, `.igapp`, loader/report, CompatibilityReport, runtime, Gate 3, or production behavior opens |
