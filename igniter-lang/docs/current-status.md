...
Active PROPs:     PROP-028 + PROP-022A temporal errata + PROP-029 entrypoint/section
                  ...
                  PROP-038 compiler_profile_contract accepted proposal-only; first proof-local implementation authorized only under experiment,
...
Source .ig
  ...
  -> RuntimeMachine
       ...
       compiler profile contract PROP                ✅ PROP-038 accepted proposal-only; proof-local Option A authorized for R63 only
...
Compiler profile/pack architecture:
                     ...
                     coverage; report-only integration, compile refusal, loader/report, CompatibilityReport,
                     dispatch, runtime, CLI, and production authority remain closed.
...
PROP-038   compiler_profile_contract     accepted proposal-only by S3-R61-C3-A;
                                         first proof-local implementation authorized by S3-R62-C3-A only;
                                         implementation beyond proof-local and production/runtime authority remain closed
