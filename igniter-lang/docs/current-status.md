...
| Ch6 SemanticIR / .igapp | ✅ synced through R36 PROP-032 experiment-pass; PROP-038 CompilationReport lag disposition routed by R89 | `spec-ch6-semanticir-temporal-sync-v0`; `stream-replay-metadata-emission-v0`; `invariant-source-metadata-preservation-v0`; `prop032-assumptions-phase3-semanticir-v0`; `prop032-assumptions-phase4-parser-proof-v0`; `prop032-assumptions-experiment-pass-decision-v0`; `compiler-mainline-touchpoint-and-proof-gap-survey-v0`; `compiler-mainline-next-axis-decision-v0` | PROP-032 experiment-pass landed; Ch2 bounded grammar sync applied in R37; PROP-033 evidence validation/runtime receipts excluded; R89 requires the next compiler-pack boundary report to include Ch6 / CompilationReport spec-lag disposition, but no Ch6 edit is authorized yet |
