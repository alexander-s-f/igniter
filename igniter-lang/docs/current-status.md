...
Source .ig
  ...
  -> RuntimeMachine
       ...
       compiler profile validator coverage           🟡 R60 proof-local next; no PROP or implementation authorization
...
Compiler profile/pack architecture:
                     ...
                     `profile_not_supplied` shape. PROP authoring remains held until the validator coverage proof
                     lands, receives pressure review, and a later Architect decision authorizes authoring.
                     Implementation, loader/report, CompatibilityReport, dispatch, runtime, CLI, and production
