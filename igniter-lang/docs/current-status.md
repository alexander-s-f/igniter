...
Compiler Internals ✅ switched CompilerOrchestrator now uses emit_typed(typed);
                            ...
                            R66 report-only integration design accepted; only next
                            bounded Candidate A implementation is authorized:
                            internal provider on CompilerOrchestrator plus
                            in-memory CompilationReport field, report-only and
                            never refusal;
...
Active PROPs:     PROP-028 + PROP-022A temporal errata + PROP-029 entrypoint/section
                  ...
                  report-only compiler integration design accepted with only next
                  bounded Candidate A implementation authorized,
...
Source .ig
  ...
  -> RuntimeMachine
       ...
       compiler profile contract PROP                ✅ PROP-038 accepted proposal-only; proof-local Option A closed by R63; internal validator extraction closed by R65; report-only integration design accepted by R66 with only next bounded Candidate A implementation authorized
...
PROP-038   compiler_profile_contract     accepted proposal-only by S3-R61-C3-A;
                                         ...
                                         report-only compiler integration design accepted by S3-R66-C3-A;
                                         only next bounded Candidate A implementation is authorized;
                                         compile refusal, public API/CLI, loader/report,
