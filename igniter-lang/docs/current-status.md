...
Source .ig
  ...
  -> RuntimeMachine
       ...
       compiler profile obligation coverage          🟡 R55 approved next proof-only/report-only axis; output-only, no `.igapp`/CLI/runtime gating
