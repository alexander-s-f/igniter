...
Compiler Internals ✅ switched CompilerOrchestrator now uses emit_typed(typed);
                            ...
                            strict-refusal result-shape/non-persisting path design
                            may open next; no implementation or live refusal authority;
...
Active PROPs:     PROP-028 + PROP-022A temporal errata + PROP-029 entrypoint/section
                  ...
                  strict-refusal result-shape/non-persisting path design-only route next,
