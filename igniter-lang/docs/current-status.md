...
Active PROPs:     PROP-028 + PROP-022A temporal errata + PROP-029 entrypoint/section
                  ...
                  PROP-038 compiler_profile_contract authoring authorized only,
...
Source .ig
  ...
  -> RuntimeMachine
       ...
       compiler profile contract PROP                🟡 PROP-038 authoring only; no implementation authorization
...
Compiler profile/pack architecture:
                     ...
                     only for the next round. Implementation, loader/report, CompatibilityReport, dispatch, runtime,
                     CLI, and production authority remain closed.
...
PROP-038   compiler_profile_contract     authoring-only route authorized by S3-R60-C3-A;
