...
|------|--------|---------|
| [tracks/observable-contract-language-v0.md](tracks/observable-contract-language-v0.md) | proposed | Explore "everything observable, everything contract" as the first language axiom |
