    ...
    def companion_routes
      ...
      get "/setup" do
        ...
        text({
          ...
          companion_effect_metadata_sidecar: service(:companion).companion_effect_metadata_sidecar,
          companion_relation_metadata_sidecar: service(:companion).companion_relation_metadata_sidecar,
          companion_store_projection_metadata_sidecar: service(:companion).companion_store_projection_metadata_sidecar,
          companion_store_schema_graph_metadata_sidecar: service(:companion).companion_store_schema_graph_metadata_sidecar,
      ...
      get "/setup/companion-effect-metadata-sidecar" do
        text service(:companion).companion_effect_metadata_sidecar.inspect
      end

      get "/setup/companion-effect-metadata-sidecar.json" do
        text JSON.pretty_generate(service(:companion).companion_effect_metadata_sidecar)
      end

      get "/setup/companion-relation-metadata-sidecar" do
        text service(:companion).companion_relation_metadata_sidecar.inspect
      end

      get "/setup/companion-relation-metadata-sidecar.json" do
        text JSON.pretty_generate(service(:companion).companion_relation_metadata_sidecar)
      end

      get "/setup/companion-store-projection-metadata-sidecar" do
        text service(:companion).companion_store_projection_metadata_sidecar.inspect
      end

      get "/setup/companion-store-projection-metadata-sidecar.json" do
        text JSON.pretty_generate(service(:companion).companion_store_projection_metadata_sidecar)
      end

      get "/setup/companion-store-schema-graph-metadata-sidecar" do
        text service(:companion).companion_store_schema_graph_metadata_sidecar.inspect
      end

      get "/setup/companion-store-schema-graph-metadata-sidecar.json" do
        text JSON.pretty_generate(service(:companion).companion_store_schema_graph_metadata_sidecar)
      end
      ...
      get "/setup/companion-store-server-topology-sidecar" do
        text service(:companion).companion_store_server_topology_sidecar.inspect
      end

      get "/setup/companion-store-server-topology-sidecar.json" do
        text JSON.pretty_generate(service(:companion).companion_store_server_topology_sidecar)
      end
