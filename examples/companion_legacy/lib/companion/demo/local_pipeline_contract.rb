...
module Companion
  # Local single-process variant of the full voice pipeline.
  #
  # Used by bin/demo and specs to show the orchestration shape without requiring
  # remote HTTP calls between orchestrator and inference nodes.
