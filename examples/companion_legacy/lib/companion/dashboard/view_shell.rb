...
module Companion
  module Dashboard
    module ViewShell
      ...
      def render_message_page(title:, eyebrow:, message:, back_label:, back_path:, detail: nil, surface_preset: default_surface_preset)
        Igniter::Plugins::View::Tailwind.render_message_page(
          ...
          **surface_preset.theme.message_page_options
        )
      end

      def default_surface_preset
        Igniter::Plugins::View::Tailwind::Surfaces.schema_authoring
      end
    end
  end
end
