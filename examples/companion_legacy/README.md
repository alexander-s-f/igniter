# Companion Legacy — Archived Pre-Refresh Demo

`examples/companion_legacy` keeps the previous companion stack as an archived reference
from before the generator-refresh migration.

Use the new [`examples/companion`](../companion/README.md) as the primary demo stand.

The notes below are preserved mainly for comparison and migration context.
...
bundle exec ruby examples/companion_legacy/stack.rb main
bundle exec ruby examples/companion_legacy/stack.rb inference
bundle exec ruby examples/companion_legacy/stack.rb dashboard
```
...
- [config/topology.yml](/Users/alex/dev/projects/igniter/examples/companion_legacy/config/topology.yml) describes deployment roles and wiring
