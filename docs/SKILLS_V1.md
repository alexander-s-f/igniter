...
| `examples/companion_legacy/apps/main/app/skills/research_skill.rb` | ResearchSkill demo |
| `examples/companion_legacy/apps/main/app/skills/remind_me_skill.rb` | RemindMeSkill demo |
