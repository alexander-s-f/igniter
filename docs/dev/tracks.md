...
| --- | --- | --- | --- | --- |
| `[Architect Supervisor / Codex]` | Maintain compact active index and decide next small implementation/process slice | [Agent Cycle Optimization](../experts/agent-cycle-optimization.md) | [Application Web POC Feedback Track](./application-web-poc-feedback-track.md), [Tracks History](./tracks-history.md) | user |
| `[Agent Application / Codex]` | Standby after feedback POC; next task pending supervisor decision | [Application Web POC Feedback Track](./application-web-poc-feedback-track.md) | [Application Web POC Task Creation Track](./application-web-poc-task-creation-track.md), [Application Rack Host DSL Track](./application-rack-host-dsl-track.md) | `[Architect Supervisor / Codex]` |
| `[Agent Web / Codex]` | Standby after feedback POC; next task pending supervisor decision | [Application Web POC Feedback Track](./application-web-poc-feedback-track.md) | [Application Web POC Task Creation Track](./application-web-poc-task-creation-track.md), [Application Web POC Skeleton Track](./application-web-poc-skeleton-track.md) | `[Architect Supervisor / Codex]` |
...
- Create `docs/dev/constraints.md` and apply named forbid sets only to new
  active tracks.
