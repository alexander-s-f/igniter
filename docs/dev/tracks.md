...
- Read-only transfer readiness report over handoff manifest and transfer
  inventory landed.
- The next broad track is a read-only transfer bundle plan.
