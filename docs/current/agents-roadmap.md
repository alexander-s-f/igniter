...
- deferred and stream agent outputs now also expose `agent_result_contract`, so execution results can project session lifecycle, interaction semantics, and tool runtime through one canonical runtime result vocabulary
